...
> ## ✅ 진행 상황 (2026-07-20)
> **Phase 0·1 완료** — 아래 F·C 태스크는 전부 끝났습니다. 이제 Phase 2의 6개 레인이 동시에 출발 가능합니다.
> 남은 것: **F2의 Figma 실제 값 교체**(구조는 완성, 값만 임시) · **F5 팀 승인**(문서상 확정, 회의 승인만 남음).
...
| U4 | 스트로크 선택 화면 | 프리셋 목록 → 선택·확정 (**커스텀 없음** · iPhone 전용) | §3.5 | F2, F3, C4 | M |
